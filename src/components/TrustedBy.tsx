...
export default function TrustedBy() {
  return (
    <section className="py-10 border-b border-slate-200 relative z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-center text-[10px] sm:text-xs uppercase tracking-[0.25em] text-slate-400 mb-6 font-semibold">
        ...
        <div className="relative overflow-hidden">
          ...
          <div className="flex animate-marquee w-max">
            {[...logos, ...logos].map((name, i) => (
              ...
              >
                <span className="font-[family-name:var(--font-space-grotesk)] text-sm sm:text-base font-extrabold text-[var(--foreground)] whitespace-nowrap tracking-wide">
                  {name}
                </span>
              </div>
            ))}
