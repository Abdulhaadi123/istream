      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {infoCards.map((card) => (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center group-hover:border-[var(--accent)]/30 group-hover:bg-[var(--accent)]/5 transition-all">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          >
            <form
              ...
              className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-6 sm:p-8 space-y-5 shadow-sm"
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-[var(--foreground)] placeholder-slate-400 focus:outline-none focus:border-[var(--primary)]/50 focus:ring-1 focus:ring-[var(--primary)]/20 transition-all text-sm"
                  />
                </div>
                <div>
                  <label className="text-xs font-semibold text-slate-600 mb-2 block">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 rounded-xl bg-[var(--card-bg)] border border-slate-200 text-slate-600 focus:outline-none focus:border-[var(--primary)]/50 focus:ring-1 focus:ring-[var(--primary)]/20 transition-all text-sm appearance-none">
                    <option value="" className="bg-[var(--background)]">Select a service</option>
                    <option value="direct-hire" className="bg-[var(--background)]">Direct Hire Recruiting</option>
                    <option value="on-demand" className="bg-[var(--background)]">On-Demand Developer Teams</option>
                    <option value="staff-aug" className="bg-[var(--background)]">IT Staff Augmentation</option>
                    <option value="remote-ops" className="bg-[var(--background)]">Remote Operations</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-[var(--foreground)] placeholder-slate-400 focus:outline-none focus:border-[var(--primary)]/50 focus:ring-1 focus:ring-[var(--primary)]/20 transition-all text-sm resize-none"
                />
              </div>

              <button
                type="submit"
                className="w-full py-3.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-[var(--primary)] to-[var(--accent)] hover:shadow-[0_4px_20px_rgba(49,152,212,0.35)] transition-all duration-300 hover:-translate-y-0.5 flex items-center justify-center gap-2 cursor-pointer"
              >
                {submitted ? (
                  <>
          ...
          >
            {/* Stats */}
            <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-6 flex-1 hover:border-[var(--primary)]/20 transition-all shadow-sm">
            ...
            {/* Book a call */}
            <div className="bg-gradient-to-br from-[var(--primary)]/10 to-[var(--accent)]/5 border border-[var(--primary)]/20 rounded-2xl p-6 shadow-sm">
              ...
              <a
                href="#"
                className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-[var(--primary)] hover:text-[var(--accent)] transition-colors"
              >
                Book a Call →
              </a>
            </div>
