...
const technologies = [
  ...
  },
  {
    ...
    svg: (
      <svg className="w-8 h-8 fill-current text-slate-800" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {technologies.map((tech, index) => (
            <motion.div
              ...
              className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-2xl p-5 hover:border-slate-300 transition-all duration-300 group hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(26,79,143,0.04)] flex items-center gap-4"
            >
              {/* Logo Frame */}
              <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-200 flex items-center justify-center shrink-0 group-hover:border-slate-300 transition-all">
                {tech.svg}
              </div>
